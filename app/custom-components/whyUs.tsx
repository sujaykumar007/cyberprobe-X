...
export default function WhyUs(){
    ...
    return  <div className=" md:ml-10 md:px-12 py-16 w-80% sm:max-[20%] md:max-[10%]  flex flex-col md:flex-row items-center justify-center overflow-y-hidden m-4 ">
    {/* Text Section */}
    ...
    <div className="w-full max-w-[90%] sm:max-w-[80%] md:max-w-[60%] lg:max-w-[50%] flex justify-center ">
      <Carousel className="md:w-[50%] w-[35%] ">
