...
export default function Approach() {
  return (
      <div className="w-full  flex md:flex-row flex-col  items-center md:justify-between bg-black gap-x-40">
           
          <h1 className="text-2xl flex flex-col items-start  sm:text-4xl md:text-5xl lg:text-5xl font-extrabold py-10 text-white w-[60%]">Our Approach to <br /> <span className="text-primary-yellow"> Penetration Testing</span>   <span className="text-white md:text-lg text-lg text-balance font-normal mt-3 hidden md:block">While every penetration test is uniquely designed to meet your specific needs,<br /> we adhere to a structured and proven methodology to ensure reliable and consistent results.
          </span></h1>
        <ShineBorder
          className=" rounded-lg bg-black h-[800px] md:h-[750px]  lg:h-[390px] lg:w-[40%] w-[50%] p-10"
