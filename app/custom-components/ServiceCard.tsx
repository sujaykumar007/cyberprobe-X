    ...
    >
      {isEven ? (
        <div className="flex justify-center w-full">
          <Card className="relative py-8 md:py-12 overflow-hidden bg-black border-opacity-35 border-gray-700 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
            <CardHeader>
              ...
              />
              <CardTitle className=" block md:hidden text-primary-yellow text-xl md:text-2xl">
                {service.name}
              </CardTitle>
              <CardDescription className="block md:hidden text-gray-300 text-sm md:text-base">
                {service.description}
              </CardDescription>
              {service.description1 && (
                <CardDescription className="text-sm md:text-base md:text-white ">
                  {service.description1}
                </CardDescription>
              )}
            </CardHeader>
        ...
        <div className="hidden md:flex justify-center">
          <span className="text-primary-yellow text-5xl font-bold ">
            {service.name}
          </span>
        </div>
      )}
      ...
      {isEven ? (
        <div className="hidden md:flex justify-center">
          <span className="text-primary-yellow text-5xl font-bold o">
            {service.name}
          </span>
        </div>
      ) : (
