...
export default function Navbar() {
  ...
  />
            ...
            {/* ✅ Mobile Side Menu */}
            <div className={`fixed top-0 right-0 w-64 h-screen bg-white shadow-lg py-20 px-10 transform transition-transform duration-500 ease-in-out z-[1000] mobile-menu
                ${isMenuOpen ? "translate-x-0" : "translate-x-full"}`}>
                
                {/* Close Button */}
                <button className='absolute right-6 top-6 text-3xl' onClick={() => setIsMenuOpen(false)}>
                    ×
                </button>
