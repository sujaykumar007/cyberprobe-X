...
export default function About() {
  ...
  return (
    <div className="w-full py-24 md:py-36 px-4 md:px-12 bg-black gap-y-20">
      <div className="w-full min-h-[600px] flex flex-col items-center py-16 md:py-6 rounded-3xl bg-black text-white px-6 md:px-12 relative">
        ...
        <div className="mt-64 flex flex-col items-center">
          ...
          <NumberTicker value={4321}  className="text-5xl md:text-7xl font-bold text-primary-yellow" />
        </div>
      ...
      {services.map((service, index) => (
        <div key={index} className="flex flex-col md:flex-row justify-between items-center mx-auto w-full md:w-[80%] px-4 md:px-12 py-10 md:py-6 space-y-6 md:space-y-0">
